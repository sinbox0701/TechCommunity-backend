...
urlpatterns = [
    ...
    path('catask/<int:pk>/<int:id>/fd', filedown, name='FD'),
    ...
    path('catask/<int:pk>/<int:tnum>/team',TaskTeamCreate,name='TaskTeam'),
    ...
    path('catask/<int:pk>/<int:tnum>/<int:id>/comupdate', comment_Update, name='comup')
